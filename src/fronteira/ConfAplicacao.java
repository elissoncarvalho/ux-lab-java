 ...
 * @author Elisson
 */
public class ConfAplicacao extends javax.swing.JFrame {

    Helper helper = new Helper();
    
    public ConfAplicacao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Configurar Aplicação");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfAplicacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfAplicacao().setVisible(true);
            }
        });
    }
